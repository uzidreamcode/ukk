  ...
  <div class="br-pageheader pd-y-15 pd-l-20">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
      ...
      <span class="breadcrumb-item active">Isi data</span>
    </nav>
  </div><!-- br-pageheader -->
  <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
    <h4 class="tx-gray-800 mg-b-5">Isi data</h4>
  </div>
    ...
    <div class="br-section-wrapper">
      ...
      <form method="post">
        ...
        <div class="form-group">
          ...
          <input required="" name="lokasi" type="text" class="form-control" id="inputAddress" placeholder="Toko Bunga Freesia">
        </div>
        <div class="form-group">
          <label for="inputAddress2">Suhu Tubuh</label>
          <input required="" maxlength="5" name="suhu" type="text" class="form-control number" id="inputAddress2" placeholder="36">
        </div>
        <div class="form-row">
          <div class="form-group col-md-6">
      ...
      if (isset($_POST['tambah'])) 
      {
        ...
        $koneksi->query("INSERT INTO catatan VALUES('','$nik','$tgl','$lokasi','$jam','$suhu','$lon','$lat') ");
  ...
  <div class="footer-right d-flex align-items-center">
    ...
    <a target="_blank" class="pd-x-5" href="https://www.facebook.com/sharer/sharer.php?u=http%3A//themepixels.me/bracket/intro"></a>
    <a target="_blank" class="pd-x-5" href="https://twitter.com/home?status=Bracket,%20your%20best%20choice%20for%20premium%20quality%20admin%20template%20from%20Bootstrap.%20Get%20it%20now%20at%20http%3A//themepixels.me/bracket/intro"></a>
  </div>
</footer>
