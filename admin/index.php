...
<head>
    <meta charset="utf-8" />
    <title>Form Editor | Xoric - Responsive Bootstrap 4 Admin Dashboard</title>
                        ...
                        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                            ...
                            <div class="collapse navbar-collapse" id="topnav-menu-content">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link" href="?halaman=isi">
                                            Isi Data
                                        </a>
            ...
            <div class="page-content">
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Peduli Diri</h4>
                ...
                <div class="page-content-wrapper">
                    <div class="container-fluid">
                        <div  class="container">
                            <div class="card">
                                <div style="padding: 100px" class="card-body">
                                    ...
                                    {?>
                                      <div class="col-xl-12">
                                        <div class="jumbotron">
                                          <h2 align="center"> APLIKASI PEDULI DIRI</h2>

                                          <p align="center"> selamat datang <strong> <?php echo $_SESSION ['nama']; ?></strong></p>
                                      </div> <!-- end card-->
                                  </div>
                              <?php }
                              ?>
