...
<body data-topbar="colored" data-layout="horizontal" data-layout-size="boxed">
                                                ...
                                                <div class="container">
                                                    ...
                                                    <form enctype="multipart/form-data"  role="form" method="post" class="login-box">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div style="margin-top: 30px" class="form-group">
                                                                            ...
                                                                            <select  required="" name="kelamin" class="form-control" id="country">
                                                                    ...
                                                                    <div style="margin-top: 30px" class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input  required="" class="form-control" type="password" name="tempat_lahir" placeholder="">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div style="margin-top: 30px" class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input  required="" class="form-control" type="date" name="tanggal_lahir" placeholder="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="tab-pane" role="tabpanel" id="step3">
                                                            <h4 style="margin-bottom: 50px; margin-top: 50px" class="text-center">Unggah Foto</h4>
                                                            <div  class="row">
                                                                <input style="margin-top: 100px" type="file" name="foto">
                                                            </div>
                                                            <ul style="margin-top: 80px" class=" text-right list-inline pull-left">
                                                                <li><button type="button" class="default-btn prev-step shadow  " disabled >Kembali</button> <button type="button" class="default-btn next-step">Lanjut</button></li>
                                                            </ul>
                                                        ...
                                                        <div class="tab-pane" role="tabpanel" id="step4">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <textarea style="width: 1100px; height: 300px" id="elm1" name="riwayat_penyakit"></textarea>
                                                        ...
                                                        <div class="tab-pane" role="tabpanel" id="step5">
                                                            <h4 style="margin-bottom: 50px; margin-top: 50px" class="text-center">Perjanjian Pengguna</h4>
                                                            <div class="row">
                                                                <textarea readonly=""  style="width: 1100px; height: 300px">
                                                                ...
                                                                <div style="margin-top: 50px" class="form-group">
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox" name="setuju" class="custom-control-input" id="invalidCheck" required>
                                                                        <label class="custom-control-label" for="invalidCheck">Saya Setuju</label>
                                                                ...
                                                                <ul style="margin-top: 80px" class=" text-right list-inline pull-left">
                                                                    <li><button type="button" class="default-btn prev-step shadow  " disabled >Kembali</button> 
                                                    ...
                                                    <button style="margin-top: 50px" name="tambah" class="btn btn-primary">Tambah</button>
    ...
    // Menguplaod gambar kedalam folder ./image
                                ...
                                $query = "INSERT INTO data VALUES ('','$nik','$kelamin','$hp','$agama','$tempat_lahir','$tanggal_lahir','$lon','$lat','$nama_gambar','$riwayat_penyakit','$setuju')";
